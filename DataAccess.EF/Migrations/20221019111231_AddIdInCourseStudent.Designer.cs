...
namespace Repository.Migrations
{
    ...
    [Migration("20221019111231_AddIdInCourseStudent")]
    partial class AddIdInCourseStudent
    {
            ...
            modelBuilder.Entity("Domain.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "9c3fe140-a036-4cf8-8742-91c5181f83c1",
                            CreationDate = new DateTime(2022, 10, 19, 14, 42, 31, 73, DateTimeKind.Local).AddTicks(5984),
            ...
            modelBuilder.Entity("Domain.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4746056f-da16-42c4-98ed-097b1d1ddb45",
                            CreationDate = new DateTime(2022, 10, 19, 14, 42, 31, 73, DateTimeKind.Local).AddTicks(6213),
                            CreatorId = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECi80A9DBZaKIkDLtwaA4gKtGZ7F/zb1QNlXfWjH+xoMCtNG38KyS/eJHmT3vfSb8w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c11a131d-3324-452f-82e9-c15cd6317aa8",
